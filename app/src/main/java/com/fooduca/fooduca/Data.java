...
public class Data {
    ...
    public Data() {
        ...
        comidas.add(new Comida("Kissitos", "Pupusa revuelta o frijol con queso", 0.55, R.drawable.kst_pupusas));
        comidas.add(new Comida("Kissitos", "3 pupusas medianas + bebida", 2.25, R.drawable.kst_pupusas));
        comidas.add(new Comida("Kissitos", "Pupusa de queso", 0.60, R.drawable.kst_pupusas));
        comidas.add(new Comida("Kissitos", "3 pupusas pequeñas", 1.00, R.drawable.kst_pupusas));
        comidas.add(new Comida("Kissitos", "Desayuno\ntípico", 2.50, R.drawable.kst_tipico));
        comidas.add(new Comida("Kissitos", "Panini desayuno", 1.75, R.drawable.jl_panini));
        comidas.add(new Comida("Kissitos", "Burrito mañanero", 1.75, R.drawable.kst_burrito));
        comidas.add(new Comida("Kissitos", "Troyana guanaca", 1.75, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Típico express", 1.75, R.drawable.kst_tipico));
        comidas.add(new Comida("Kissitos", "Pancakes", 2.50, R.drawable.kst_pancake));
        comidas.add(new Comida("Kissitos", "Meltys 1 ingrediente", 2.75, R.drawable.kst_meltys));
        comidas.add(new Comida("Kissitos", "Croissant pequeño", 2.75, R.drawable.kst_croissant));
        comidas.add(new Comida("Kissitos", "Meltys con huevo", 3.00, R.drawable.kst_meltys));
        comidas.add(new Comida("Kissitos", "Troyana 1 ingrediente", 3.00, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Espartano pequeño", 3.00, R.drawable.kst_espartano));
        comidas.add(new Comida("Kissitos", "Filete a la plancha", 3.25, R.drawable.kst_a_la_plancha));
        comidas.add(new Comida("Kissitos", "Atenas", 3.25, R.drawable.kst_atena));
        comidas.add(new Comida("Kissitos", "Tacos", 3.25, R.drawable.ep_tacos_tostados));
        comidas.add(new Comida("Kissitos", "4 Mozarella Sticks", 3.25, R.drawable.kst_mozarella));
        comidas.add(new Comida("Kissitos", "Croissant con Omelette", 3.25, R.drawable.kst_croissant));
        comidas.add(new Comida("Kissitos", "Troyana Búfalo", 3.25, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Italiana", 3.25, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Mexicana", 3.25, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana 3 Quesos", 3.25, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Suprema", 3.50, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Chipotle", 3.50, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Meat lovers", 3.50, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Californiana", 3.50, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Troyana Alfredo", 3.50, R.drawable.kst_troyana));
        comidas.add(new Comida("Kissitos", "Burrito pollo/res", 3.50, R.drawable.kst_burrito));
        comidas.add(new Comida("Kissitos", "7 chunks", 3.50, R.drawable.kst_chunks));
        comidas.add(new Comida("Kissitos", "Stick sampler", 3.50, R.drawable.kk_dedos_queso));
        comidas.add(new Comida("Kissitos", "Hamburguesa", 3.50, R.drawable.jl_hamburguesa));
        comidas.add(new Comida("Kissitos", "Lasagna", 3.50, R.drawable.kst_lasagna));
        comidas.add(new Comida("Kissitos", "Hulk", 3.75, R.drawable.kst_hulk));
        comidas.add(new Comida("Kissitos", "Ensalada", 3.75, R.drawable.kst_ensaladas));
        comidas.add(new Comida("Kissitos", "Papitas francesas tradicionales", 2.00, R.drawable.kst_papas));
        comidas.add(new Comida("Kissitos", "Papitas francesas especialidades", 2.50, R.drawable.kst_papas));
        comidas.add(new Comida("Kissitos", "Papitas francesas tradicionales (media orden)", 1.25, R.drawable.kst_papas));
        comidas.add(new Comida("Kissitos", "Papitas francesas especialidades (media orden)", 1.75, R.drawable.kst_papas));
        ...
        comidas.add(new Comida("Kissitos", "Crepa de nutella + fresas + banano + brownie", 2.25, R.drawable.kst_crepa_dulce));
        comidas.add(new Comida("Kissitos", "Crepa dulce de leche + fresas + banano + brownie", 2.25, R.drawable.kst_crepa_dulce));
        comidas.add(new Comida("Kissitos", "Crepa pollo", 2.50, R.drawable.kst_crepa_salada));
        comidas.add(new Comida("Kissitos", "Crepa hongos", 2.50, R.drawable.kst_crepa_salada));
        comidas.add(new Comida("Kissitos", "Crepa jamon", 2.50, R.drawable.kst_crepa_salada));
        comidas.add(new Comida("Kissitos", "Crepa tocino", 2.50, R.drawable.kst_crepa_salada));
        comidas.add(new Comida("Kissitos", "Crepa tres quesos", 2.50, R.drawable.kst_crepa_salada));
